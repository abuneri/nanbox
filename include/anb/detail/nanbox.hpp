...
/*
	...
	Currently x86_64 implementations only use up to 48-bits of virtual address
	space, as that gives 256 TiB of memory, which is more than enough for today's
	current compute needs. Hopefuly if/when this breaks and more address space is
	needed, it will only be on x86_128 so we can still do NaN-boxing :D
//=====================================================================
// References
